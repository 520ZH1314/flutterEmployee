class MonthDataPostBean {
  ...
  MonthDataPostBean({this.AppCode, this.ApiCode, this.UserCode, this.ShiftDate, this.TenantId, this.TeamId});

  MonthDataPostBean.fromJson(Map<String, dynamic> json) {    
